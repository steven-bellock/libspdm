...
static void rsp_encapsulated_request_case16(void **State)
{
    ...
    const struct {
        ...
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, true, SPDM_GET_SUPPORTED_EVENT_TYPES, true },
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, true, SPDM_SUBSCRIBE_EVENT_TYPES, true },
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, false, SPDM_KEY_UPDATE, false },
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, false, SPDM_SEND_EVENT, false },
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, false, SPDM_GET_SUPPORTED_EVENT_TYPES, false },
        { LIBSPDM_ENCAP_FLOW_REQ_INITIATED, false, SPDM_SUBSCRIBE_EVENT_TYPES, false },
